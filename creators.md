...
The creators / KOLs whose videos feed the **[[Creator Wisdom — MOC]]**. Edit freely —
add a row per creator. Claude uses `default tags` and `notes language` when processing.
